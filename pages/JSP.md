...
JSP page to make it thread safe.14. How will you include a static file in
a JSP page?
...
E.g. <%@ include file="footer.html" %>15. What are the lifecycle methods of a
JSP?
...
implementation of dynamic data.17. What is the advantage of JSP over
Javascript?
...
the cleanup of any resources held by JSP.19. What is a JSP expression?
...
page.
E.g. <%= expression =%>20. What are the different types of
directive tags in JSP?
JSP has following directive tags:
1.
Page: This directive is used for page related attributes. It
...
created.23. What is pageContext in JSP?
...
package.24. What is the use of jsp:useBean in
JSP?
...
Later this bean can be used in expressions or JSP code.25. What is difference between
...
called and then include it in the JSP page.26. How will you use other Java files
...
classes that we are planning to use in JSP code.27. How will you use an existing class
...
E.g.
<%@ include page extends=“parent_class” %>28. Why _jspService method starts
...
cannot be overridden by client code.29. Why do we use tag library in JSP?
...
writing code only once and using is multiple times.30. What is the different type of tag
...
Formatting tags
XML tags
JSTL Functions31. How will you pass information
...
information.32. How will you call a stored
procedure from JSP?
...
class to invoke stored procedure from a JSP.33. Can we override _jspService()
method in JSP?
...
jspDestroy().34. What is a directive in JSP?
...
a URL.
Like- www.abcserver.com?sessionid=123436. How do you debug code in JSP?
...
operations of debugging like breakpoint, step through etc.37. How will you implement error
page in JSP?
...
it to errorPage.
<% page errorPage=”ErrorPage.jsp” %>38. How will you send XML data from
a JSP?
...
E.g. <%@page contentType=”text/xml” %>39. What happens when we request
...
JSP container to client browser.40. How will you implement Auto
...
of the JSP page.
E.g. response.setIntHeader(“Refresh”,10)41. What are the important status
codes in HTTP?
...
pass over the internet.43. What is the difference between
...
complex code and can be also reused.44. How will you delete a Cookie in
JSP?
...
cookie after specified time period.45. How will you use a Cookie in JSP?
...
and retrieve its value.46. What is the main difference
...
<!-- comment -->
If we output comment in above format, it will be visible to client.49. How will you prevent caching of
...
response.setDateHeader(“Expires”,”0”);50. How will you redirect request to
...
Sample code is as follows:
<% response.sendRedirect(URL); %>51. What is the difference between
...
declared
in
HttpServletResponse object.52. What is the use of config implicit
object in JSP?
...
initialization parameters for a specific JSP page.53. What is the difference between
...
be used by all the JSP/Servlet in that Container.54. What is the purpose of
RequestDispatcher?
...
and then we can call include or forward method on this object.55. How can be read data from a
Form in a JSP?
...
the Parameters in Form.56. What is a filter in JSP?
